...
class Utility extends Model
{
    ...
    public static function fetchSettings($user_id = null)
    {
        ...
        $settings = [
            ...
            "metakeyword" => "",
            "metadesc" => "",
            "zoom_account_id" => "LQ_07jRHRRmB236ix8GmVQ",
            "zoom_client_id" => "r7fRQeVmTBq2dKe_ByKyOw",
            "zoom_client_secret" => "ii6BA3HUMHWxsXMSp2bkBaXOiSahvfin",
            ...
            'contactus_url' => '#',
            'chatgpt_key' => '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',
